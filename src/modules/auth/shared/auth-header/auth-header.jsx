...
const AuthHeader = () => {
  ...
  return (
    <div className="flex items-center justify-center py-1.5 ps-3 pe-1.5 relative">
      <div className="logo_bx">
        <Link to="/">
          <img src={Images.logo_3_png} alt="pic" className="w-72" />
        </Link>
      </div>

      <div className="language_bx absolute end-1.5">
